...
const ExhibitionsPage = () => {
  ...
  const exhibitions: Exhibition[] = [
    {
      ...
      description: "Contemporary reflections on distance and presence in modern art, exploring themes of isolation and connection in our digital age.",
    ...
    },
    {
      ...
      description: "Monochrome expressions of Korean contemporary masters, featuring works that speak to the quieter moments of human experience.",
    ...
    },
    {
      ...
      description: "Exploring urban identity through conceptual installations that challenge our perception of space and community.",
      longDescription: "An exploration of urban displacement, migration, and the search for home in contemporary society. These artists use architectural elements, textile works, and conceptual frameworks to examine how globalization affects personal and cultural identity.",
      status: 'upcoming',
    ...
    },
    {
      ...
      description: "Contemporary artists reimagining traditional materials and techniques for the modern world.",
      longDescription: "This exhibition examines how contemporary Korean artists are reinterpreting traditional materials, techniques, and cultural practices for the 21st century. Through sculpture, installation, and performance, these artists create new dialogues between past and present.",
      status: 'upcoming',
      location: 'K1 Main Gallery',
      featured: false
    },
    {
      ...
      description: "A journey through time and memory, examining how landscape shapes our understanding of history and identity.",
      longDescription: "An immersive exploration of how landscape and environment shape collective memory and cultural identity. These works examine the relationship between natural and constructed environments, investigating how places hold and transmit cultural knowledge across generations.",
      status: 'past',
      location: 'K2 Hanok Space',
      featured: false
    },
    {
      ...
      description: "Exploring the intersection of technology and cultural expression in contemporary digital art practices.",
      longDescription: "A survey of how digital technologies are creating new forms of cultural expression and artistic practice. This exhibition features interactive installations, AI-generated artworks, and immersive digital environments that challenge traditional boundaries between artist, artwork, and audience.",
      status: 'past',
      location: 'K3 Project Space',
      featured: false
    }
  ...
  const filteredExhibitions = exhibitions.filter(exhibition => 
    filter === 'all' || exhibition.status === filter
  )
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroText}>
              <div className={styles.heroMeta}>
                ...
                <p className={styles.heroSubtitle}>{currentExhibition.subtitle}</p>
              </div>
              ...
              <div className={styles.heroDetails}>
                ...
                <p className={styles.heroLocation}>{currentExhibition.location}</p>
              ...
              <div className={styles.heroButtons}>
                <Link href={`/exhibitions/${currentExhibition.id}`} className={styles.btnPrimary}>
                  View Details
                </Link>
        ...
        <div className={styles.filterContent}>
          <div className={styles.filterHeader}>
            ...
            <p className={styles.filterDescription}>
              Discover our complete collection of past, current, and upcoming exhibitions
            </p>
          </div>
          ...
          <div className={styles.filterButtons}>
            ...
            >
              Current ({exhibitions.filter(ex => ex.status === 'current').length})
            </button>
            <button 
        ...
        <div className={styles.exhibitionsContent}>
          {filteredExhibitions.length > 0 ? (
                ...
                <div key={exhibition.id} className={styles.exhibitionCard}>
                  <div className={styles.exhibitionImage}>
                    ...
                    <div className={styles.exhibitionImageOverlay}>
                      <span className={`${styles.exhibitionStatus} ${styles[exhibition.status]}`}>
                        {exhibition.status}
                      </span>
                    </div>
                  </div>
            ...
            <div className={styles.noResults}>
              ...
              <p>There are currently no exhibitions matching your selected filter.</p>
            </div>
          )}
        </div>
      </section>
        ...
        <div className={styles.newsletterContent}>
          <div className={styles.newsletterText}>
            ...
            <p className={styles.newsletterDescription}>
              Subscribe to our newsletter to receive updates about new exhibitions, 
              opening receptions, artist talks, and special events.
            </p>
          </div>
